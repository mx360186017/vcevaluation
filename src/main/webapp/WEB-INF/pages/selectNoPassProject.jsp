				...
				<div class="container">
					<div class="row">
						...
						<div class="main col-md-12">
							...
							<c:forEach items="${nopasspro}" var="nopasspro">
								<div class="col-md-3 col-sm-6 isotope-item">
									<div class="image-box">
										<div class="overlay-container">
											<img style="max-width:260.5px; max-height:166px;" src="<%= basePath%>/static/adStyle/img/${nopasspro.pro_type}" id="${status.index+1}"  alt="">
											<div class="overlay">
												<div class="overlay-links">
													<a href="/vcevaluation/projectItem?pro_id=${nopasspro.pro_id}"><i class="fa fa-link"></i></a>
													<a href="<%= basePath%>/static/adStyle/img/${nopasspro.pro_type}" class="popup-img"><i class="fa fa-search-plus"></i></a>
												</div>
												<span>Web Design</span>
											</div>
										</div>
										<div class="image-box-body">
											<h3 style="white-space:nowrap;overflow:hidden;text-overflow:ellipsis;" class="title"><a href="portfolio-item.html">${ nopasspro.pro_name}</a></h3>
											<div style="text-overflow:ellipsis;word-wrap: break-word;height:67.5px;width:230px;overflow:hidden;">${ nopasspro.pro_plan}</div>
											
											<span>${usermap[nopasspro.pro_creater]}</span>
											<div class="elements-list pull-right">
												
												<a  href="/vcevaluation/projectItem?pro_id=${nopasspro.pro_id}" ><span>项目详情</span></a>
											</div>
							...
							<ul class="pagination">
									...
									<li ${pager.pageNum==1?'class="disabled"':''}><a href="selectNoPassProject?pageNum=1">首页</a></li>
									<li ${pager.pageNum==1?'class="disabled"':''}><a href="selectNoPassProject?pageNum=${pager.pageNum-1 }">上页</a></li>		
									<li ${pager.pageNum==pager.pageCount?'class="disabled"':''}><a href="selectNoPassProject?pageNum=${pager.pageNum+1 }">下页</a></li>
									<li ${pager.pageNum==pager.pageCount?'class="disabled"':''}><a href="selectNoPassProject?pageNum=${pager.pageCount }">末页</a></li>
									<li><a >转到 </a></li>
