					...
					<div class="row">
						...
						<div class="main col-md-12">
							...
							<!-- 评估论文 -->
								...
								<form role="form" id="Evaform2"  action="evaluationSoftware" method="post"  onsubmit="return validation();">	
								<!-- pills start -->
								<div>
								...
								<div class="process">
									...
									<div class="tab-content clear-style">
										<div class="tab-pane active" id="pill-pr-1">
											<h3>系统评估指标值仅供参考</h3>
											<p>软件先进性由<a href="">是否发布</a>和<a href="">完成时间</a>两个因素作为估算因素</p>
										...
										<div>
											<input type="hidden" id="software_indexEva1" name="software_indexEva1"
												value="${m}" />
										</div>
										...
										<div class="tab-pane" id="pill-pr-2">
										    <h3>系统评估指标值仅供参考</h3>
											<p>软件可靠性由<a href="">可移植性</a>和<a href="">功能完备性</a>两个因素作为估算因素</p>
											<table class="table table-bordered">
												<thead>
													<tr>
														<th>评估因素</th>
											...
											<div>
											<input type="hidden" id="software_indexEva2" name="software_indexEva2"
												value="${n}" />
										    </div>
