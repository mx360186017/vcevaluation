					...
					<div class="row">
						...
						<div class="main col-md-12">
							...
							<!-- 评估论文 -->
								...
								<form role="form" id="Evaform"  action="evaluationPaper" method="post"  onsubmit="return validation();">	
								<!-- pills start -->
								<div>
								...
								<div class="process">
									...
									<div class="tab-content clear-style">
										<div class="tab-pane active" id="pill-pr-1">
											<h3>系统评估指标值仅供参考</h3>
											<p>论文先进性由<a href="">被引用次数</a>和<a href="">出版年份</a>两个因素作为估算因素</p>
										...
										<div>
											<input type="hidden" id="paper_indexEva1" name="paper_indexEva1"
												value="${m}" />
										</div>
										...
										<div class="tab-pane" id="pill-pr-2">
										    <h3>系统评估指标值仅供参考</h3>
											<p>论文可靠性由<a href="">科学索引库</a>和<a href="">期刊CJCR（影响因子）</a>两个因素作为估算因素</p>
											<table class="table table-bordered">
												<thead>
													<tr>
														<th>评估因素</th>
												...
												<tbody>
												    ...
												    <tr>
												        <td colspan="2">该期刊CJCR值为：${journal.j_factor}</td>
														<td>该指标（先进性）加权估值为</td>
														<td>${n}</td>
										            </tr>
												</tbody>
											...
											<div>
											<input type="hidden" id="paper_indexEva2" name="paper_indexEva2"
												value="${n}" />
										    </div>
