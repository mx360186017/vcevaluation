...
!function (a, b) {
    ...
    var c = [], d = c.slice, e = c.concat, f = c.push, g = c.indexOf, h = {}, i = h.toString, j = h.hasOwnProperty, k = {}, l = "3.0.0-pre 3699ef463224a08233f9c37c6c7ad8235eb9a758+compat", m = function (a, b) {
        return new m.fn.init(a, b)
    }, n = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, o = /^-ms-/, p = /-([a-z])/g, q = function (a, b) {
        return b.toUpperCase()
    };
    m.fn = m.prototype = {
        jquery: l, constructor: m, length: 0, toArray: function () {
            return d.call(this)
        }, get: function (a) {
        ...
        expando: "jQuery" + (l + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (a) {
            ...
            var b = y.head || m("head")[0] || y.documentElement, c = y.createElement("script");
    ...
    var x, y = a.document, z = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, A = m.fn.init = function (a, b, c) {
        var d, e;
        if (!a)return this;
        if (c = c || x, "string" == typeof a) {
            ...
            if (d[1]) {
                if (b = b instanceof m ? b[0] : b, m.merge(this, m.parseHTML(d[1], b && b.nodeType ? b.ownerDocument || b : y, !0)), u.test(d[1]) && m.isPlainObject(b))for (d in b)m.isFunction(this[d]) ? this[d](b[d]) : this.attr(d, b[d]);
                return this
            }
    ...
    m.extend({
        Deferred: function (a) {
            var b = [["notify", "progress", m.Callbacks("memory"), m.Callbacks("memory"), 2], ["resolve", "done", m.Callbacks("once memory"), m.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", m.Callbacks("once memory"), m.Callbacks("once memory"), 1, "rejected"]], c = "pending", d = {
                state: function () {
                    return c
                }, always: function () {
                    ...
                    function g(a, b, c, e) {
                        return function () {
                            var h = this === d ? void 0 : this, i = arguments, j = function () {
                                var d, j;
                                if (!(f > a)) {
            ...
            var b, c = 0, e = d.call(arguments), f = e.length, g = 1 !== f || a && m.isFunction(a.promise) ? f : 0, h = 1 === g ? a : m.Deferred(), i = function (a, b, c) {
                return function (e) {
                    b[a] = this, c[a] = arguments.length > 1 ? d.call(arguments) : e, c === j ? h.notifyWith(b, c) : --g || h.resolveWith(b, c)
                }
            }, j, k, l;
            if (f > 1)for (j = new Array(f), k = new Array(f), l = new Array(f); f > c; c++)e[c] && m.isFunction(b = e[c].promise) ? b.call(e[c]).progress(i(c, k, j)).done(i(c, l, e)).fail(h.reject) : e[c] && m.isFunction(b = e[c].then) ? b.call(e[c], i(c, l, e), h.reject, i(c, k, j)) : --g;
    ...
    function X(a, b, c, d) {
        var e, f = 1, g = 20, h = d ? function () {
            ...
            return m.css(a, b, "")
        }, i = h(), j = c && c[3] || (m.cssNumber[b] ? "" : "px"), k = (m.cssNumber[b] || "px" !== j && +i) && T.exec(m.css(a, b));
        if (k && k[3] !== j) {
            j = j || k[3], c = c || [], k = +i || 1;
    ...
    }, $ = /^(?:checkbox|radio)$/i, _ = /<([\w:-]+)/, aa = /^$|\/(?:java|ecma)script/i, ba = /^\s+/, ca = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|dialog|figcaption|figure|footer|header|hgroup|main|mark|meter|nav|output|picture|progress|section|summary|template|time|video";

    function da(a) {
        var b = ca.split("|"), c = a.createDocumentFragment();
        if (c.createElement)while (b.length)c.createElement(b.pop());
        return c
    }

    !function () {
        var a = y.createElement("div"), b = y.createDocumentFragment();
    ...
    function fa(a, b) {
        ...
        if (!f)for (f = [], c = a.childNodes || a; null != (d = c[e]); e++)!b || m.nodeName(d, b) ? f.push(d) : m.merge(f, fa(d, b));
    ...
    function ia(a, b, c, d, e) {
        for (var f, g, h, i, j, l, n = a.length, o = da(b), p = [], q = 0; n > q; q++)if (g = a[q], g || 0 === g)if ("object" === m.type(g))m.merge(p, g.nodeType ? [g] : g); else if (ha.test(g)) {
        ...
        while (g = p[q++])if (d && m.inArray(g, d) > -1)e && e.push(g); else if (h = m.contains(g.ownerDocument, g), i = fa(o.appendChild(g), "script"), h && ga(i), c) {
            f = 0;
    ...
    m.event = {
        ...
        setup: function () {
            ...
            a._submitBubble && (delete a._submitBubble, this.parentNode && !a.isTrigger && m.event.simulate("submit", this.parentNode, a, !0))
        }, teardown: function () {
        ...
        setup: function () {
            return ja.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (m.event.add(this, "propertychange._change", function (a) {
                ...
                this._justChanged && !a.isTrigger && (this._justChanged = !1), m.event.simulate("change", this, a, !0)
            })), !1) : void m.event.add(this, "beforeactivate._change", function (a) {
                var b = a.target;
                ja.test(b.nodeName) && !m._data(b, "changeBubbles") && (m.event.add(b, "change._change", function (a) {
    ...
    var ra = / jQuery\d+="(?:null|\d+)"/g, sa = new RegExp("<(?:" + ca + ")[\\s/>]", "i"), ta = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, ua = /<(?:script|style|link)/i, va = /checked\s*(?:[^=]|=\s*.checked.)/i, wa = /^true\/(.*)/, xa = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, ya = da(y), za = ya.appendChild(y.createElement("div"));
    ...
    function Fa(a, b, c, d) {
        b = e.apply([], b);
        var f, g, h, i, j, l, n = 0, o = a.length, p = o - 1, q = b[0], r = m.isFunction(q);
        ...
        if (o && (l = ia(b, a[0].ownerDocument, !1, a, d), f = l.firstChild, 1 === l.childNodes.length && (l = f), f || d)) {
            ...
            if (h)for (j = i[i.length - 1].ownerDocument, m.map(i, Ca), n = 0; h > n; n++)g = i[n], aa.test(g.type || "") && !m._data(g, "globalEval") && m.contains(j, g) && (g.src ? m._evalUrl && m._evalUrl(g.src) : m.globalEval((g.text || g.textContent || g.innerHTML || "").replace(xa, "")));
            l = f = null
        }
        return a
    }
    ...
    m.extend({
        htmlPrefilter: function (a) {
            ...
            if (k.html5Clone || m.isXMLDoc(a) || !sa.test("<" + a.nodeName + ">") ? f = a.cloneNode(!0) : (za.innerHTML = a.outerHTML, za.removeChild(f = za.firstChild)), !(k.noCloneEvent && k.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || m.isXMLDoc(a)))for (d = fa(f), h = fa(a), g = 0; null != (e = h[g]); ++g)d[g] && Ea(e, d[g]);
            if (b)if (c)for (h = h || fa(a), d = d || fa(f), g = 0; null != (e = h[g]); g++)Da(e, d[g]); else Da(a, f);
            return d = fa(f, "script"), d.length > 0 && ga(d, !i && fa(a, "script")), d = h = e = null, f
        }, cleanData: function (a, b) {
            for (var d, e, f, g, h = 0, i = m.expando, j = m.cache, l = k.attributes, n = m.event.special; null != (d = a[h]); h++)if ((b || m.acceptData(d)) && (f = d[i], g = f && j[f])) {
    ...
    var Ga = /^margin/, Ha = new RegExp("^(" + S + ")(?!px)[a-z%]+$", "i");
    !function () {
    ...
    var Ma = /alpha\([^)]*\)/i, Na = /opacity\s*=\s*([^)]*)/i, Oa = /^(none|table(?!-c[ea]).+)/, Pa = new RegExp("^(" + S + ")(.*)$", "i"), Qa = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    ...
    function Ta(a, b) {
        if (b in a)return b;
        var c = b[0].toUpperCase() + b.slice(1), d = b, e = Sa.length;
        while (e--)if (b = Sa[e] + c, b in a)return b;
        return d
    }
    ...
    function Wa(a, b, c) {
        var d = !0, e = "width" === b ? a.offsetWidth : a.offsetHeight, f = Ia(a), g = "border-box" === m.css(a, "boxSizing", !1, f);
        if (0 >= e || null == e) {
    ...
    var Ya, Za, $a = /^(?:toggle|show|hide)$/, _a = /queueHooks$/, ab = [gb], bb = {
        "*": [function (a, b) {
    ...
    function cb() {
        Za && (a.requestAnimationFrame(cb), m.fx.tick())
    }
    ...
    function gb(a, b, c) {
        var d, e, f, g, h, i, j, k, l = "width" in b || "height" in b, n = this, o = {}, p = a.style, q = a.nodeType && V(a), r = m._data(a, "fxshow");
    ...
    function ib(a, b, c) {
        var d, e, f = 0, g = ab.length, h = m.Deferred().always(function () {
            delete i.elem
        }), i = function () {
            if (e)return !1;
        ...
        for (hb(k, j.opts.specialEasing); g > f; f++)if (d = ab[f].call(j, a, k, j.opts))return d;
        return m.map(k, fb, j), m.isFunction(j.opts.start) && j.opts.start.call(a, j), m.fx.timer(m.extend(i, {
            elem: a,
            anim: j,
            queue: j.opts.queue
    ...
    m.Animation = m.extend(ib, {
        ...
        Za = a.requestAnimationFrame ? a.requestAnimationFrame(cb) : setInterval(m.fx.tick, m.fx.interval)
    }, m.fx.stop = function () {
        a.cancelAnimationFrame ? a.cancelAnimationFrame(Za) : clearInterval(Za), Za = null
    ...
    var kb, lb = m.expr.attrHandle, mb = /^(?:checked|selected)$/i, nb = k.input;
    m.fn.extend({
        attr: function (a, b) {
        ...
        attr: function (a, b, c) {
            ...
            if (f && 1 === a.nodeType)while (c = f[e++])d = m.propFix[c] || c, m.expr.match.bool.test(c) && (nb || !mb.test(c) ? a[d] = !1 : a[m.camelCase("default-" + c)] = a[d] = !1), a.removeAttribute(c)
        }, attrHooks: {
            type: {
                set: function (a, b) {
    ...
    var ob = /^(?:input|select|textarea|button|object)$/i, pb = /^(?:a|area)$/i;
    m.fn.extend({
        prop: function (a, b) {
    ...
    m.fn.extend({
        addClass: function (a) {
            var b, c, d, e, f, g, h, i = 0, j = this.length, k = "string" == typeof a && a;
            if (m.isFunction(a))return this.each(function (b) {
                m(this).addClass(a.call(this, b, rb(this)))
            });
            if (k)for (b = (a || "").match(E) || []; j > i; i++)if (c = this[i], e = rb(c), d = 1 === c.nodeType && (" " + e + " ").replace(qb, " ")) {
                g = 0;
            ...
            var b, c, d, e, f, g, h, i = 0, j = this.length, k = 0 === arguments.length || "string" == typeof a && a;
            if (m.isFunction(a))return this.each(function (b) {
                m(this).removeClass(a.call(this, b, rb(this)))
            });
            if (k)for (b = (a || "").match(E) || []; j > i; i++)if (c = this[i], e = rb(c), d = 1 === c.nodeType && (" " + e + " ").replace(qb, " ")) {
                g = 0;
            ...
            return "boolean" == typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : this.each(m.isFunction(a) ? function (c) {
                m(this).toggleClass(a.call(this, c, rb(this), b), b)
            } : function () {
                var b, d, e, f;
                if ("string" === c) {
            ...
            for (var b = " " + a + " ", c = 0, d = this.length; d > c; c++)if (1 === this[c].nodeType && (" " + rb(this[c]) + " ").replace(qb, " ").indexOf(b) > -1)return !0;
            return !1
        }
    ...
    var ub = /#.*$/, vb = /([?&])_=[^&]*/, wb = /^(.*?):[ \t]*([^\r\n]*)$/gm, xb = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, yb = /^(?:GET|HEAD)$/, zb = /^\/\//, Ab = {}, Bb = {}, Cb = "*/".concat("*"), Db = y.createElement("a");
    Db.href = location.href;
    function Eb(a) {
        return function (b, c) {
            "string" != typeof b && (c = b, b = "*");
            var d, e = 0, f = b.toLowerCase().match(E) || [];
            if (m.isFunction(c))while (d = f[e++])"+" === d[0] ? (d = d.slice(1) || "*", (a[d] = a[d] || []).unshift(c)) : (a[d] = a[d] || []).push(c)
        }
    }
    ...
    m.extend({
        ...
        ajaxSettings: {
            url: location.href,
            type: "GET",
            isLocal: xb.test(location.protocol),
            global: !0,
            processData: !0,
            async: !0,
        ...
        ajax: function (a, b) {
            ...
            if (o.promise(v), k.url = ((a || k.url || location.href) + "").replace(ub, "").replace(zb, location.protocol + "//"), k.type = b.method || b.type || k.method || k.type, k.dataTypes = m.trim(k.dataType || "*").toLowerCase().match(E) || [""], null == k.crossDomain) {
                g = y.createElement("a");
                try {
                    g.href = k.url, g.href = g.href, k.crossDomain = Db.protocol + "//" + Db.host != g.protocol + "//" + g.host
                } catch (w) {
                    k.crossDomain = !0
                }
            }
    ...
    function Ob(a, b, c, d) {
        ...
        }); else if (c || "object" !== m.type(b))d(a, b); else for (e in b)Ob(a + "[" + e + "]", b[e], c, d)
    }
            ...
            return {
                send: function (c, d) {
                    ...
                    f.send(a.hasContent && a.data || null), b = function (c, e) {
                        var g, h, i;
                        if (b && (e || 4 === f.readyState))if (b = void 0, f.onreadystatechange = m.noop, e)4 !== f.readyState && f.abort(); else {
    ...
    m.ajaxSetup({
        ...
        return h || "jsonp" === b.dataTypes[0] ? (e = b.jsonpCallback = m.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback, h ? b[h] = b[h].replace(Tb, "$1" + e) : b.jsonp !== !1 && (b.url += (tb.test(b.url) ? "&" : "?") + b.jsonp + "=" + e), b.converters["script json"] = function () {
            ...
            a[e] = f, b[e] && (b.jsonpCallback = c.jsonpCallback, Sb.push(e)), g && m.isFunction(f) && f(g[0]), g = f = void 0
        }), "script") : void 0
    ...
    m.offset = {
        ...
        offset: function (a) {
            ...
            if (f)return d = f.getBoundingClientRect(), d.width || d.height || f.getClientRects().length ? (e = f.ownerDocument, c = Wb(e), b = e.documentElement, {
