...
(function (d) {
    d.fn.sortableLists = function (e) {
        ...
        function B(a, e) {
            ...
            if (c && e.oElOld) {
                ...
                if (5 > h)a:{
                    ...
                    l.css("display", "block");
                    b.isAllowed = f.isAllowed(b.cEl.el, d("#sortableListsHint"),
                        c)
                } else if (g - 5 < h)a:{
                    d("#sortableListsHintWrapper", b.rootEl.el).length && l.unwrap();
                    if (a.pageX - c.offset().left < f.insertZone) {
        ...
        var u = d("body").css("position", "relative"), E = {
            ...
            baseCss: {
                position: "absolute",
                top: 0 - parseInt(u.css("margin-top")),
                left: 0 - parseInt(u.css("margin-left")),
                margin: 0,
                padding: 0,
                "z-index": 2500
            },
