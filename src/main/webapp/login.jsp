				...
				<div class="row">
					<div class="col-sm-6 col-sm-offset-3 form-box">
						...
						<div class="form-bottom">
							<form role="form" action="login" method="post" class="login-form" onsubmit="return checkNamePwd();">
								<div class="form-group">
									<label class="sr-only" for="form-username">用户名</label> <input
										type="text" name="u_name" placeholder="用户名..."
										class="form-username form-control" id="u_name">
										<label id="prompt_name" style="font-size:9px;display:none;"></label>
								</div>
								<div class="form-group">
									<label class="sr-only" for="form-password">密码</label> <input
										type="password" name="u_pwd" placeholder="密码..."
										class="form-password form-control" id="u_pwd">
